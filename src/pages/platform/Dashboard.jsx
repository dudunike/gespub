...
export default function Dashboard() {
  ...
  const [followers, setFollowers] = useState({ fbFollowers: 0, igFollowers: 0, igUsername: null })
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-white border border-border rounded-card p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-xs text-txt-secondary ml-1">total nas páginas</span>
          </div>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-txt-primary">
                  {followers.igFollowers > 0 ? formatNumber(followers.igFollowers) : '—'}
                </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-txt-primary">
                  {followers.fbFollowers > 0 ? formatNumber(followers.fbFollowers) : '—'}
                </p>
                <p className="text-[10px] text-txt-secondary mt-0.5">Curtidas na página</p>
              </div>
            </div>
          </div>
          {followers.fbFollowers === 0 && followers.igFollowers === 0 && (
            <p className="mt-3 text-xs text-txt-secondary border-t border-border pt-3">
              Reconecte o Meta Ads com as permissões atualizadas para ver seguidores.
            </p>
          )}
        </div>
